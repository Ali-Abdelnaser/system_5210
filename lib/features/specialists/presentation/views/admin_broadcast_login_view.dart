...
class AdminBroadcastLoginView extends StatefulWidget {
  ...
  @override
  State<AdminBroadcastLoginView> createState() =>
      _AdminBroadcastLoginViewState();
}

class _AdminBroadcastLoginViewState extends State<AdminBroadcastLoginView> {
      ...
      if (query.docs.isNotEmpty) {
        if (mounted) {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => const AdminNotificationControlView(),
            ),
          );
        }
      } else {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    isAr ? 'نظام إرسال التنبيهات' : 'Notification Control',
