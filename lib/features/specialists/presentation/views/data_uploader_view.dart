  ...
  final List<RecipeModel> premiumRecipes = [
    ...
    const RecipeModel(
      ...
      stepsEn: [
        ...
        'Coat with oat flour, then egg, then crushed rice cakes.',
        'Cook in air fryer with olive oil spray until golden.',
        'Mix sauce ingredients and serve.',
      ],
      stepsAr: [
        'تبلي الدجاج بالتوابل.',
        'غطيها بدقيق الشوفان بثم البيض ثم الرايس كيك المطحون.',
        'اطهيها في القلاية الهوائية مع رشة زيت حتى تصبح ذهبية.',
        'اخلطي مكونات الصوص وقدميها.',
      ],
    ...
    const RecipeModel(
      ...
      stepsEn: [
        'Boil spices with milk.',
        'Strain into a cup.',
        'Sweeten with honey.',
      ],
      stepsAr: ['اغلي التوابل مع اللبن.', 'صفي المشروب في كوب.', 'حلي بالعسل.'],
    ...
    const RecipeModel(
      ...
      stepsEn: [
        'Mix mashed potatoes with eggs and spices.',
        'Cook on a pan like pancakes.',
        'Top with nuts and honey.',
      ],
      stepsAr: [
        'اخلطي البطاطا المهروسة مع البيض والبهارات.',
        'اطبخيها في المقلاة مثل البان كيك.',
        'زينها بالمكسرات والعسل.',
      ],
    ...
    const RecipeModel(
      ...
      stepsAr: [
        'اغلي الجنزبيل في الماء.',
        'أضيفي زيت الزيتون والعسل.',
        'قدميه دافئاً.',
      ],
    ...
    const RecipeModel(
      ...
      stepsEn: [
        'Grind sesame.',
        'Mix with tahini and honey.',
        'Press into mold and refrigerate.',
      ],
      stepsAr: [
        'اطحني السمسم.',
        'اخلطي مع الطحينة والعسل.',
        'اضغطيه في قالب واتركيه في الثلاجة.',
      ],
    ...
    const RecipeModel(
      ...
      ingredientsAr: [
        ...
        '١٢ تمرة',
        'نص كوب فستق حلبي',
        '٨٠ جرام دارك تشوكليت',
      ],
      stepsEn: [
        'Blend dates and oats.',
        'Shape and add pistachios.',
        'Coat with melted dark chocolate.',
      ],
      stepsAr: [
        'اخلطي التمر والشوفان.',
        'شكليه وأضيفي الفستق.',
        'غطيه بالشوكولاتة الداكنة المذابة.',
      ],
    ...
    const RecipeModel(
      ...
      stepsEn: [
        'Blend potatoes with egg yolks, milk and stevia.',
        'Bake until set.',
        'Caramelize top if desired.',
      ],
      stepsAr: [
        'اخلطي البطاطا مع صفار البيض واللبن والستيفيا.',
        'اخبزيها في الفرن حتى تتماسك.',
        'كرملي الوجه حسب الرغبة.',
      ],
    ...
    const RecipeModel(
      ...
      stepsEn: [
        'Stuff dates with tahini and coconut.',
        'Coat with chocolate and sprinkle salt.',
      ],
      stepsAr: [
        'احشي التمر بالطحينة وجوز الهند.',
        'غطيه بالشوكولاتة ورشة ملح.',
      ],
    ...
    const RecipeModel(
      ...
      stepsEn: ['Mix ingredients and cook in a pan.', 'Add toppings and fold.'],
      stepsAr: ['اخلطي المكونات واطبخيها في المقلاة.', 'أضيفي الحشوة واطويها.'],
    ...
    const RecipeModel(
      ...
      stepsEn: ['Mix ingredients and bake.', 'Pour healthy syrup when done.'],
      stepsAr: ['اخلطي المكونات واخبزيها.', 'صبي الشربات الصحي بعد النضج.'],
    ...
    const RecipeModel(
      ...
      stepsEn: [
        'Blend cheese with cocoa and spread.',
        'Freeze and coat with chocolate.',
      ],
      stepsAr: [
        'اخلطي الجبنة مع الكاكاو والسبريد.',
        'جمديها وغطيها بالشوكولاتة.',
      ],
    ...
    const RecipeModel(
      ...
      stepsEn: ['Blend ingredients.', 'Cook on pan.', 'Add banana and honey.'],
      stepsAr: [
    ...
    const RecipeModel(
      ...
      stepsEn: ['Mix ingredients.', 'Form patties and air fry.'],
      stepsAr: ['اخلطي المكونات.', 'شكليها واطبخيها في القلاية الهوائية.'],
